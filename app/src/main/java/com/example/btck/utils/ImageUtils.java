...
public class ImageUtils {
     ...
     * Replaces the host and port of the original URL with e1.chiasegpu.vn:11997.
     */
    public static String getFullImageUrl(String originalUrl) {
        ...
        // If the URL already contains e1.chiasegpu.vn:11997, just return it
        if (originalUrl.contains("e1.chiasegpu.vn:11997")) {
            return originalUrl;
        }
        ...
        try {
            ...
            return "http://e1.chiasegpu.vn:11997" + (path != null && path.startsWith("/") ? path : "/" + path);
        } catch (Exception e) {
